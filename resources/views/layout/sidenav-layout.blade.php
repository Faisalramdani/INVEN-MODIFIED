...
<head>
    ...
    <link href="{{ secure_asset('https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css') }}"
        rel="stylesheet" />
...
<body>
        ...
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="#">
                <span class="icon-nav h5 m-0" onclick="MenuBarClickHandler()">
                    <img class="nav-logo-sm mx-2" src="{{ secure_asset('images/menu.svg') }}" alt="logo" />
                </span>
                <img class="nav-logo mx-2" src="{{ secure_asset('images/logo-website-SRVE-Link.png') }}"
                    alt="logo" />
            </a>

            <div class="d-flex float-right h-auto">
                <div class="user-dropdown">
                    <img class="icon-nav-img" src="{{ secure_asset('images/user.webp') }}" alt="" />
    ...
    <div class="side-nav-open" id="sideNavRef">
        ...
        <a class="side-bar-item" href="{{ route('web.agent') }}">

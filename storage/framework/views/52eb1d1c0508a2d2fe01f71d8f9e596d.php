                    ...
                    <div class="row">
                        ...
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 text-end">
                            <div class="icon icon-shape bg-gradient-primary float-end border-radius-md shadow">
                                <img class="w-100" src="<?php echo e(asset('images/icon.svg')); ?>" />
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    async function getList() {
        showLoader();
        let res = await axios.get('/api/summary', { withCredentials: true });
        ;
        res = res.data[0];
...
<?php /**PATH C:\Users\HP\Downloads\inven-modified\resources\views/components/dashboard/summary.blade.php ENDPATH**/ ?>
            ...
            <div class="col-md-4 col-lg-4 p-2">
                <div class="h-100 rounded-3 bg-white p-3 shadow-sm">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <img class="w-50" src="<?php echo e('images/logo.png'); ?>">
                            <p class="text-bold text-dark mx-0 my-1">Invoice </p>
                            <p class="mx-0 my-1 text-xs">Date: <?php echo e(date('Y-m-d')); ?> </p>
                        </div>
                    </div>
        ...
        async function createInvoice() {
            ...
            if (CId.length === 0) {
                ...
                if (res.data['success'] === true) {
                    window.location.href = '<?php echo e(route('web.invoice')); ?>'
...
<?php echo $__env->make('layout.sidenav-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel-11-Inventory-main\resources\views/dashboard/sale-page.blade.php ENDPATH**/ ?>
    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-light py-2 shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img class="img-fluid" src="<?php echo e(asset('/images/logo.png')); ?>" alt="" width="96px">
            </a>
        ...
        <div class="container pt-2">
            <div class="row align-items-center mb-5">
                <div class="col-12 col-md-10 col-lg-5 mb-lg-0 mb-5">
                    ...
                    <div class="d-flex flex-wrap"><a class="btn bg-gradient-primary mb-sm-0 mb-2 me-2" href="<?php echo e(route('web.login')); ?>">Start Sale</a>
